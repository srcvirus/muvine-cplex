...
class VNESolutionBuilder {
 public:
  ...
  // Prints the routing information for newly established OTN links on stdout.
  ...
  // (<otn_src>, <otn_dst>, <module_type>, <src_idx>, <dst_idx>)->(<dwdm_src>,
  // <dwdm_dst>, <lambda>)
  void PrintNewOTNLinks(const char *filename);
